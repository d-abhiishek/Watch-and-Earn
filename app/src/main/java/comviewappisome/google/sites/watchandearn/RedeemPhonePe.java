...
public class RedeemPhonePe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_redeem_phone_pe);
    ...
    public void checkout(View view) {
        if(mobileno.length() <= 9 || mobileno.length() >= 11){
            ...
            String request = "PhonePe-" + mobileno.getText().toString();
            ...
            myRef1.push().setValue("Payment (via PhonePe) - (-10,000 Coins)");
        }
