...
public class RedeemGPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_redeem_gpay);
    ...
    public void checkout(View view) {
        if(mobileno.length() <= 9 || mobileno.length() >= 11){
            ...
            String request = "GPay-" + mobileno.getText().toString();
            ...
            myRef1.push().setValue("Payment (via Google Pay) - (-10,000 Coins)");
        }
    }
}
